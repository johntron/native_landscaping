...
/**
 * The observation feed: saved monitoring areas (hand-entered, so
 * data/saved-areas.db cannot be rebuilt), the raw event log, the paged feed with
 * read/dismissed state, and the on-demand poll.
 *
